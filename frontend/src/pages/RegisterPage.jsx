...
import { BookOpen, UserPlus, Lock, Mail, User, AlertCircle, Loader2 } from 'lucide-react';
...
export const RegisterPage = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setError(err.response?.data?.message || 'Failed to register. Email may already be taken.');
    } finally {
      setSubmitting(false);
    }
  };
